        ...
        <div className="relative h-screen flex items-center justify-center bg-white dark:bg-stone-900 text-stone-900 dark:text-stone-300">
            ...
            <div className="relative z-10 text-center">
                ...
                <p className="text-sm sm:text-lg max-w-5xl mx-auto font-light">
                    I'm a Melbourne-based developer with a Master of Engineering in Mechatronics from the University of Melbourne, currently working as a Software Developer at Data Annotation Tech, where I focus on improving AI model performance. I have experience in front-end development, data management, and e-commerce platforms, with skills in Python, Java, JavaScript, Vue, React, and MongoDB. Connect with me!
                </p>
